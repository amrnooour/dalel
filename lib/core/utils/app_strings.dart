abstract class AppStrings {
  ...
  //!On Boarding Strings
      ...
      from = "From every place on earth ",
      abig = "A big variety of ancient places from all over the world",
      modern = "Using modern AI technology for better user experience",
      all = "AI provide recommendations and helps you to continue the search journey",
      next = "Next",
